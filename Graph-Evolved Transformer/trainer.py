	...
	def train(self):
		...
		for e in range(self.args.num_epochs):
			...
			if len(self.splitter.test)>0 and e>self.args.eval_after_epochs:
				...
				test_list.append(eval_test)
				
				#print('Test Measure:',eval_test)
		...
		all_dict["validation"] = valid_list
		all_dict["test"] = test_list

		
		with open('all_data_o.pickle','wb') as file:
